...
import {
    homeListingsData, personalListingsData, jobsListingsData, communityListingsData,
...
const Listings = () => {
    const listingTypes = {
        '/listings/housing': homeListingsData, '/listings/personal': personalListingsData,
                ...
                <div className="col-12 py-3">
                    <div className="row d-flex align-items-center g-4">
                        <div className="col d-flex flex-wrap align-items-center">
                            ...
                            {/* Filter button */}
                            <div role='button' onClick={openCloseFilter} style={{ color: 'blue' }}>
                ...
                {data.map((data, key) => {
                    return (
                        <div key={key}>
                            <Col>
                                <Card style={{
                                    width: '18rem', justifyContent: 'space-around',
